    ...
    !function(t, e) {
      ...
      var O = function() {
        ...
        return e2.getValue = function(t3) {
          ...
          var t3 = [];
          for (var e3 in this._scale) t3.push({ label: e3, value: this._scale[e3] });
          return t3;
        }, t2;
      }(), X = function() {
      ...
      var T = Object.freeze({ __proto__: null, handleContainerEvents: function() {
        ...
        var t2, e2;
        for (t2 in this.regionLabelsGroup = this.regionLabelsGroup || this.canvas.createGroup("jvm-regions-labels-group"), this.mapData.paths) e2 = new M({ map: this, code: t2, path: this.mapData.paths[t2].path, style: f.merge({}, this.params.regionStyle), labelStyle: this.params.regionLabelStyle, labelsGroup: this.regionLabelsGroup, label: this.params.labels && this.params.labels.regions }), this.regions[t2] = { config: this.mapData.paths[t2], element: e2 };
        ...
        for (var t2 in this.series = { markers: [], regions: [] }, this.params.series) for (var e2 = 0; e2 < this.params.series[t2].length; e2++) this.series[t2][e2] = new X(this.params.series[t2][e2], this[t2], this);
        ...
        var t2;
        for (var e2 in this.markers) false !== (t2 = this.getMarkerPosition(this.markers[e2].config)) && this.markers[e2].element.setStyle({ cx: t2.x, cy: t2.y });
