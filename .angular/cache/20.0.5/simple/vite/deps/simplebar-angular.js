...
var _c0 = ["*"];
var _SimplebarAngularComponent = class _SimplebarAngularComponent {
...
_SimplebarAngularComponent.ɵfac = function SimplebarAngularComponent_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _SimplebarAngularComponent)(ɵɵdirectiveInject(ElementRef), ɵɵdirectiveInject(NgZone));
};
_SimplebarAngularComponent.ɵcmp = ɵɵdefineComponent({
...
var SimplebarAngularComponent = _SimplebarAngularComponent;
(() => {
...
var _SimplebarAngularModule = class _SimplebarAngularModule {
};
_SimplebarAngularModule.ɵfac = function SimplebarAngularModule_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _SimplebarAngularModule)();
};
_SimplebarAngularModule.ɵmod = ɵɵdefineNgModule({
  type: _SimplebarAngularModule,
  declarations: [SimplebarAngularComponent],
  exports: [SimplebarAngularComponent]
});
_SimplebarAngularModule.ɵinj = ɵɵdefineInjector({});
var SimplebarAngularModule = _SimplebarAngularModule;
(() => {
