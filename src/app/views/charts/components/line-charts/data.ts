...
export const basicLineChartOptions = (): ChartConfiguration => ({
  type: 'line',
  data: {
...
export const interpolationChartOptions = (): ChartConfiguration => ({
  type: 'line',
  data: {
...
export const multiAxesChartOptions = (): ChartConfiguration => ({
  type: 'line',
  data: {
...
export const pointStyleChartOptions = (): ChartConfiguration => ({
  type: 'line',
  data: {
...
export const lineSegmentChartOptions = (): ChartConfiguration => ({
  type: 'line',
  data: {
    labels: ['Jan', 'Feb', 'March', 'April', 'May', 'June', 'July'],
    datasets: [
      {
        ...
        segment: {
          borderColor: (ctx) =>
            skipped(ctx, getColor('chart-dark-rgb', 0.2)) ||
            down(ctx, getColor('danger')),
...
export const steppedChartOptions = (): ChartConfiguration => ({
  type: 'line',
  data: {
    labels: ['Day 1', 'Day 2', 'Day 3', 'Day 4', 'Day 5', 'Day 6'],
    datasets: [
