...
@Component({
  ...
  imports: [UiCard],
  template: `
    <app-ui-card title="Typography Variations" [isTogglable]="true">
      <div class="row g-4" card-body>
        ...
        <div class="col-xl-6">
          ...
          <dl class="row mb-0">
            ...
            <dd class="col-sm-9">
              An overview panel that displays key metrics and activity
              summaries.
            </dd>
            ...
            <dd class="col-sm-9">
              <p>
                Includes validation for all major input types with real-time
                feedback.
              </p>
            ...
            <dd class="col-sm-9">
              Utilizes Bootstrap’s flexible grid layout for consistent
              responsiveness across devices.
            </dd>

            <dt class="col-sm-3 text-truncate">User Management Module</dt>
            <dd class="col-sm-9">
              Easily manage roles, permissions, and user profiles from a single
              interface.
            </dd>
            ...
            <dd class="col-sm-9">
              <dl class="row mb-0">
                ...
                <dd class="col-sm-8">
                  Customizable alerts and triggers integrated into app
                  workflows.
                </dd>
              </dl>
            </dd>
